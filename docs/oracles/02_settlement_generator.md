...
## 🏛️ Step 1: Settlement Scale & Government (1d6)
...
## 🗣️ Step 3: Tavern Rumor Mill (1d8)

| 1d8 | Frontier Rumor | Authenticity / Threat Link |
| :---: | :--- | :--- |
| **1** | *"A goblin warband dug into an ancient barrow 2 hexes north and found an unhallowed iron gate."* | **True:** Leads to [Hex 04 Barrow Crypt](../campaign_record/hex_atlas_19.md). |
| **2** | *"The water in Whispering Delta is tasting of black bile; fishermen saw tentacles beneath the fog."* | **True:** Clue for [Vector A: Sunken Sovereign](../campaign_record/threat_vectors.md). |
| **3** | *"An eccentric gnome tinkerer in Glimmercap is offering 50 gp for 2 intact giant spider venom sacs."* | **Opportunity:** Alchemical bounty quest. |
| **4** | *"The local bailiff is accepting bribes from the Whispering Shadow syndicate to look away from caravans."* | **Faction hook:** Influence over local guard. |
| **5** | *"Smugglers found a secret chasm entrance leading 3 miles down into sunless subterranean rivers."* | **True:** Leads to [Hex 06 Underdark Karst](../campaign_record/hex_atlas_19.md). |
