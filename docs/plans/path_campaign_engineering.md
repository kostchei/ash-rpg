...
| P5: Complete Night Below | P4 | Author all three acts and environments; prisoner routes, controlled minds, descent/aquatic access, finale alternatives. Link starting leads to actual sites and earned inter-zone travel. Rehearse an uninterrupted three-act persisted campaign. |
...
| P7: Prove adapter reuse | P5–P6 | Complete Domains of Dread and Eternal Cycle; three zones inside the domain, domain boundary preservation, conditional victory and noncombat rewards. No path-name UI special cases. |
